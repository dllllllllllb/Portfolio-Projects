...
IconButton::IconButton(sf::RenderWindow& rWindow, Textures* pTextures) : 
	UIElement(rWindow, pTextures)
{

}

IconButton::IconButton(sf::RenderWindow& rWindow, Textures* pTextures, const bool setThinBorder) :
	UIElement(rWindow, pTextures, setThinBorder)
{
}
